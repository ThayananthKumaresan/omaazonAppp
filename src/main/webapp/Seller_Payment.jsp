...
<div class="container">
		...
		<div class="row justify-content-center">
			...
			<tr>
        			...
        			<td class="text-center">TR<%=listOfTransaction.get(i).getTransactionID()%>  </td>
					<td class="text-center"><%=listOfTransaction.get(i).getTransactionDateTime()%>  </td>
					<td > RM <%=listOfTransaction.get(i).getTransactionAmount()%> </td>
			</tr>
