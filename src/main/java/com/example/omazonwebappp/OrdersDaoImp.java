...
public class OrdersDaoImp implements OrdersDao {
    ...
    /**
     * This method read the list of order of customer
     *
    ...
    /**
     * This method read the list of order of seller
     *
     * @param sessionSellerID
